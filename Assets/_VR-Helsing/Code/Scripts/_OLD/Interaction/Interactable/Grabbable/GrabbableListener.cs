...
namespace _VanHelsingVR.Interaction
{
    ...
    public abstract class GrabbableListener : InteractableListener
    {
        protected UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable _grabbable;

        protected override void Awake()
        {
            base.Awake();
            _grabbable = GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>();
        }
