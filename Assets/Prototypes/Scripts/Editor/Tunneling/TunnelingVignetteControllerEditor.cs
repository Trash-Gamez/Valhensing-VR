...
public class TunnelingVignetteControllerEditor : BaseInteractionEditor
{
    ...
    /// </summary>
    readonly List<string> m_PreviewList = new();
    ...
    /// </summary>
    readonly Dictionary<string, List<TunnelingProvider>> m_LocomotionProvidersByGOName = new();
    ...
    /// </summary>
    readonly Dictionary<string, List<string>> m_LocomotionProviderNamesByGOName = new();
    ...
    /// </summary>
    readonly List<int> m_LocomotionProviderSelectedIndexes = new();
    ...
    /// </summary>
    List<LocomotionVignetteProvider> m_ControllerLocomotionVignetteProviders = new();
    ...
    /// </summary>
    static readonly Dictionary<TunnelingVignetteController, int> s_ControllerPreviewIndex = new();
...
#else
        s_CachedLocomotionProviders = FindObjectsOfType<TunnelingProvider>();
#endif
    ...
    void InitializeLocomotionProviderDropDownDisplay()
    {
        ...
        foreach (var component in s_CachedLocomotionProviders)
        {
            ...
            var locomotionProvidersArray = go.GetComponents<TunnelingProvider>();
            var newLocomotionProviders = new List<TunnelingProvider>();
