...
public sealed class VignetteParameters
{
    ...
    public static class Defaults
    {
        ...
        /// </summary>
        public static readonly VignetteParameters defaultEffect = new()
        {
        ...
        /// </summary>
        public static readonly VignetteParameters noEffect = new()
        {
...
/// <summary>
/// An interface that provides <see cref="global::VignetteParameters"/> needed to control the tunneling vignette effect.
/// </summary>
...
public class LocomotionVignetteProvider : ITunnelingVignetteProvider
{
    ...
    /// and instead use the customized <see cref="global::VignetteParameters"/> defined by this class.
    /// </summary>
    ...
    [SerializeField]
    VignetteParameters m_OverrideParameters = new();

    /// <summary>
    /// The <see cref="global::VignetteParameters"/> that this <see cref="LocomotionVignetteProvider"/> uses to control the vignette
...
public class TunnelingVignetteController : MonoBehaviour
{
    ...
    [SerializeField]
    VignetteParameters m_DefaultParameters = new();
    ...
    [SerializeField]
    VignetteParameters m_CurrentParameters = new();
    ...
    [SerializeField]
    List<LocomotionVignetteProvider> m_LocomotionVignetteProviders = new();
    ...
    /// </summary>
    readonly List<ProviderRecord> m_ProviderRecords = new();
    ...
    public void PreviewInEditor(VignetteParameters previewParameters)
    {
    ...
    protected virtual void Update()
    {
        ...
        foreach (var record in m_ProviderRecords)
        {
            ...
            switch (record.EaseState)
            {
                ...
                default:
                    UnityEngine.Debug.LogError($"Unhandled {nameof(EaseState)}={record.EaseState}");
                    break;
            }
        }
    ...
    {
        if (m_MeshRender == null && !TryGetComponent<MeshRenderer>(out m_MeshRender))
        ...
        {
            UnityEngine.Debug.LogWarning("The default mesh for the TunnelingVignetteController is not set. " +
        ...
        if (m_MeshRender.sharedMaterial == null)
        {
            ...
            {
                UnityEngine.Debug.LogWarning("The default material for the TunnelingVignetteController is not set, and the default Shader: " + k_DefaultShader
                    + " cannot be found. Make sure they are imported from the Tunneling Vignette Sample of XR Interaction Toolkit.", this);
                return false;
            }

            UnityEngine.Debug.LogWarning("The default material for the TunnelingVignetteController is not set. " +
